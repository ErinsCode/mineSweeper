...
public class Cell
{
	 ...
	 */
	public Cell(int value, boolean isFlagged, boolean isVisable)
	{
		this(value);
	 ...
	 * 
	 * @param value Sets the new value of the cell. 9 makes the cell a mine, 0-8 stands for the number of other mines that this cell is touching.
	 */
